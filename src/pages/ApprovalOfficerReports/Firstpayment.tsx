...
//     useState<ReportType>("FirstPaymentCompleted");

//   const apiEndpoints: Record<ReportType, string> = {
//     FirstPaymentCompleted: `${BASE_API_URL}user/getReportingDetailsForFirstPaymentCompleted`,
//     FinalPaymentCompleted: `${BASE_API_URL}user/getReportingDetailsForFinalPaymentCompleted`,
//     CompletedHearing: `${BASE_API_URL}user/getReportingDetailsForCompletedHearing`,
//     LicenseGenerated: `${BASE_API_URL}user/getReportingDetailsForLicenseGenerated`,
//   };
...
//   // ✅ Re-fetch data when dates or report type change
//   useEffect(() => {
//     if (fromDate && toDate) {
//       fetchReportData();
//     }
//   }, [fromDate, toDate, reportType, fetchReportData]);
...
//         {/* Error Toast */}
//         {error && (
//           <div className="fixed bottom-6 right-6 z-50 bg-red-600 text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3">
