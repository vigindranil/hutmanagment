...
//     const fetchCheckerDashboard = async () => {
//         try {
//             setLoading(true);
...
//             setError(null);
//         } catch (err) {
//             console.error('Error fetching checker dashboard:', err);
...
//                     <StatsCard dashboardType="CHECKER" key={index} {...stat} />
//                 ))}
//             </div>
//         </div>
//     );
