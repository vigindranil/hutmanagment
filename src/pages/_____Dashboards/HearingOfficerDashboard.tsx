...
// const HearingOfficerDashboard: React.FC = () => {
//     const [stats, setStats] = useState<any>(null);
//     const [loading, setLoading] = useState(true);
//     const [error, setError] = useState<string | null>(null);

//     const fetchHearingOfficerDashboard = async () => {
//         try {
//             setLoading(true);
...
//             setError(null);
//         } catch (err) {
//             console.error('Error fetching hearing officer dashboard:', err);
...
//                     <StatsCard dashboardType="HEARING_OFFICER" key={index} {...stat} />
//                 ))}
//             </div>
//         </div>
//     );
...
// export default HearingOfficerDashboard;
